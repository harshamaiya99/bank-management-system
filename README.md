...
│   │   └── routes.py               # API and HTML route definitions
│   └── frontend/
│       ├── accountDetails.html     # Frontend template for account details
│       ├── createAccount.html      # Frontend template for creating an account
│       └── index.html              # Frontend home page template
├── tests/
│   └── api/
│       ├── data/
│       │   └── accounts.csv        # Test data for API tests
│       ├── reports/                # Allure test reports output directory
│       │   ├── allure-reports/     # Generated Allure HTML reports
│       │   └── allure-results/     # Raw Allure test results
│       ├── services/
│       │   ├── accounts_api.py     # API client for accounts endpoints
│       │   └── base_api.py         # Base API client with request/response logging
│       ├── utils/
│       │   ├── allure_logger.py    # Utility for attaching API details to Allure reports
│       │   └── csv_reader.py       # Utility to read test data from CSV
│       └── test_accounts_api.py    # Pytest API tests for account CRUD operations
├── conftest.py                     # Pytest configuration and Allure report generation hook
